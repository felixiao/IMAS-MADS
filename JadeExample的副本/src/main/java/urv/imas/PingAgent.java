    ...
    private class WaitPingAndReplyBehaviour extends CyclicBehaviour {
        ...
        public void action() {
            ...
            if(msg != null){
                ...
                if(msg.getPerformative()== ACLMessage.REQUEST || msg.getPerformative()== ACLMessage.INFORM|| msg.getPerformative()== ACLMessage.REFUSE ) {
                    ...
                    myLogger.log(Logger.INFO, "Agent " + getLocalName() + " will reply " + reply.getContent());
                    send(reply);
                }
//                else {
//                    myLogger.log(Logger.INFO, "Agent "+getLocalName()+" - Unexpected message ["+ACLMessage.getPerformative(msg.getPerformative())+"] '"+msg.getContent()+"' received from "+msg.getSender().getLocalName());
//                    reply.setPerformative(ACLMessage.NOT_UNDERSTOOD);
//                    reply.setContent("( (Unexpected-act "+ACLMessage.getPerformative(msg.getPerformative())+") )");
//                    myLogger.log(Logger.INFO, "Agent " + getLocalName() + " will reply [NOT_UNDERSTOOD] 'Unexpected-act' to Agent " + reply.getInReplyTo());
//                }
            }
